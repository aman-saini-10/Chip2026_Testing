...
HD_PWD='C:/Chip2026_Testing/CHIP2026_TestingSetup/CHIP2026_TestingSetup.runs/design_1_Verilog_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Verilog_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Verilog_Controller_0_0.tcl
