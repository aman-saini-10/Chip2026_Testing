...
/* Definitions for peripheral DIG_AXI_OUT_BUS */
#define XPAR_DIG_AXI_OUT_BUS_BASEADDR 0x41200000
#define XPAR_DIG_AXI_OUT_BUS_HIGHADDR 0x4120FFFF
#define XPAR_DIG_AXI_OUT_BUS_DEVICE_ID 0
#define XPAR_DIG_AXI_OUT_BUS_INTERRUPT_PRESENT 0
#define XPAR_DIG_AXI_OUT_BUS_IS_DUAL 0


/* Definitions for peripheral DIG_DEBUG_AXI_OUT_BUS_0 */
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_0_BASEADDR 0x41210000
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_0_HIGHADDR 0x4121FFFF
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_0_DEVICE_ID 1
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_0_INTERRUPT_PRESENT 0
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_0_IS_DUAL 0


/* Definitions for peripheral DIG_DEBUG_AXI_OUT_BUS_1 */
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_1_BASEADDR 0x41220000
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_1_HIGHADDR 0x4122FFFF
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_1_DEVICE_ID 2
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_1_INTERRUPT_PRESENT 0
#define XPAR_DIG_DEBUG_AXI_OUT_BUS_1_IS_DUAL 0


/* Definitions for peripheral SCAN_MODE_SETTINGS_AXI_BUS */
#define XPAR_SCAN_MODE_SETTINGS_AXI_BUS_BASEADDR 0x41230000
#define XPAR_SCAN_MODE_SETTINGS_AXI_BUS_HIGHADDR 0x4123FFFF
#define XPAR_SCAN_MODE_SETTINGS_AXI_BUS_DEVICE_ID 3
#define XPAR_SCAN_MODE_SETTINGS_AXI_BUS_INTERRUPT_PRESENT 0
#define XPAR_SCAN_MODE_SETTINGS_AXI_BUS_IS_DUAL 0
...
/* Canonical definitions for peripheral DIG_AXI_OUT_BUS */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_DIG_AXI_OUT_BUS_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral DIG_DEBUG_AXI_OUT_BUS_0 */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_DIG_DEBUG_AXI_OUT_BUS_0_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral DIG_DEBUG_AXI_OUT_BUS_1 */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_DIG_DEBUG_AXI_OUT_BUS_1_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral SCAN_MODE_SETTINGS_AXI_BUS */
#define XPAR_GPIO_3_BASEADDR 0x41230000
#define XPAR_GPIO_3_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_SCAN_MODE_SETTINGS_AXI_BUS_DEVICE_ID
