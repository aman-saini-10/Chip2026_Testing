...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = DIG_AXI_OUT_BUS
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = DIG_DEBUG_AXI_OUT_BUS_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = DIG_DEBUG_AXI_OUT_BUS_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = SCAN_MODE_SETTINGS_AXI_BUS
END
